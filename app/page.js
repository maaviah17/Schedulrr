    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
            ...
            <p className="text-xl text-gray-600 mb-10">Schedulrr helps you manage your time effectively. Create events, set your availability, and let others 
        ...
        <div className="lg:w-1/2 flex justify-center">
          <div className="relative w-full max-w-md aspect-square">
            <Image src="/poster.png" alt="scheduling" layout="fill" objectFit="contain" />
          </div>
        </div>
      </div>
              ...
              {features.map((f,index)=>{
                return (
                  <Card key={index}>
                    ...
                    <CardTitle className="text-center text-blue-500">{f.title}</CardTitle>
                    </CardHeader>
                    <CardContent>
      ...
      <div className="mb-24">
        <h2 className="text-3xl font-bold text-center mb-12 text-blue-600">What Users Say</h2>
        <Testimonials />
      </div>
      ...
      <div className="text-white bg-blue-600 rounded-lg p-8 text-center">
